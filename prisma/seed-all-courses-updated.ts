...
async function seedSalesCourse() {
  console.log('🎯 Seeding Sales Mastery Course...')
  ...
  console.log('✅ Sales Mastery course seeded')
}

async function seedLeadershipCourse() {
  ...
  console.log('✅ Leadership & Influence course seeded')
}

async function seedMarketingCourse() {
  ...
  console.log('✅ Digital Marketing Mastery course seeded')
}

async function seedWealthCourse() {
  ...
  console.log('✅ Wealth Building course seeded')
}

async function main() {
  console.log('🚀 Starting complete course update...\n')
  
  await seedSalesCourse()
  await seedLeadershipCourse()
  await seedMarketingCourse()
  await seedWealthCourse()
