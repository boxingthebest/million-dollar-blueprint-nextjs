...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      {/* Why Million Dollar Blueprint - Value Proposition */}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border-2 border-orange-500/30 rounded-2xl p-8 md:p-12 shadow-2xl shadow-orange-500/10 hover:shadow-orange-500/20 transition-all duration-300 hover:scale-[1.02]">
              <div className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-white leading-relaxed">
                  Free content is scattered and overwhelming. Our courses are a <span className="text-purple-400 font-bold">proven, step-by-step system</span> with accountability, real-world case studies, and frameworks you can implement Monday morning.
                </p>
                
                <p className="text-lg md:text-xl text-white leading-relaxed">
                  You're not buying information—you're buying <span className="text-emerald-400 font-bold">years of trial and error compressed into hours</span>, so you don't waste a decade figuring it out yourself.
                </p>
              ...
              <div className="bg-red-900/20 border-2 border-red-500/30 rounded-xl p-6 md:p-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-2">
                    ...
                    <span><span className="font-bold text-white">2-5 years</span> of trial and error</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 mt-1">•</span>
                    <span><span className="font-bold text-white">$50K-$200K</span> in lost salary growth</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 mt-1">•</span>
                    <span><span className="font-bold text-white">Countless hours</span> sifting through scattered content</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 mt-1">•</span>
                    <span><span className="font-bold text-white">Missed promotions</span> while competitors advance</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-900/20 border-2 border-emerald-500/30 rounded-xl p-6 md:p-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-2">
                    ...
                    <span><span className="font-bold text-white">Implement in weeks</span>, not years</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span><span className="font-bold text-white">$47K average</span> salary increase (our students)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span><span className="font-bold text-white">Battle-tested frameworks</span> from elite companies</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400 mt-1">•</span>
                    <span><span className="font-bold text-white">Lifetime access</span> for less than 1 day of coaching</span>
                  </li>
                </ul>
              </div>
            </div>
