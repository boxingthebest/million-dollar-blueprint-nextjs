  ...
  return (
    <div className="min-h-screen bg-slate-950 relative">
      ...
      <section className="py-16 md:py-24 relative overflow-hidden animated-gradient-bg">
        ...
        <div className="absolute inset-0 bg-[url('/sales-mastery-hero-final.jpg')] bg-cover bg-top opacity-20" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block bg-orange-500/20 text-orange-300 px-6 py-2 rounded-full text-sm font-bold mb-6">
              💰 $247 • 253 Students Enrolled • Only 47 Spots Left This Month
            </div>
            ...
            <a
              href="https://buy.stripe.com/6oU8wO3L31zV4hKe9c88g61"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="aspect-video rounded-xl overflow-hidden shadow-2xl border-2 border-slate-600">
              <div style={{padding: '56.25% 0 0 0', position: 'relative'}}>
                <iframe 
                  src="https://player.vimeo.com/video/1130648006?badge=0&autopause=0&player_id=0&app_id=58479&playsinline=1&muted=0" 
                  frameBorder="0" 
              ...
              <div key={module.number} className="bg-black border-2 border-slate-600 rounded-lg mb-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 p-4 rounded-full shadow-lg shadow-orange-500/50">
                      <module.icon className="h-14 w-14 text-orange-400" />
                    </div>
                    <div>
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <Check className="h-14 w-14 text-orange-400 mt-1 flex-shrink-0" />
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-orange-500/20 to-red-500/20">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-cyan-400 rounded-2xl p-8 md:p-12 shadow-2xl shadow-cyan-500/20">
              ...
              <div className="border-t-2 border-b-2 border-cyan-400/30 py-8 mb-8">
                ...
                <p className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 text-center mb-4">
                  Sales Mastery Certificate
                </p>
                <p className="text-white text-center text-sm md:text-base">
                  Demonstrating mastery in: MEDDPICC Framework, SPIN Selling, Challenger Sale, Value-Based Selling
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-white font-mono text-xs">MDB-SAL-XXXXX</p>
                </div>
                <div>
