  ...
  const modules = [
    ...
    },
    {
      ...
      topics: [
        ...
        "LinkedIn strategies from Fortune 500 executives",
        "The \"Personal Board of Directors\" concept",
        "Networking that actually works (quality over quantity)",
        "Key takeaway: Your reputation precedes you. Manage it."
      ]
    },
    {
      number: 8,
      ...
      topics: [
        ...
        "How to build coalitions and strategic alliances",
        "The art of diplomatic disagreement",
        "Protecting yourself from political landmines",
        "Key takeaway: Politics is a game. Learn the rules or lose."
      ]
    },
    {
      number: 9,
      title: "Leading High-Stakes Meetings",
      duration: "10 min",
      lessons: 1,
      icon: Users,
      topics: [
        "How to run board-level meetings like a CEO",
        "The \"Pre-Wire\" technique for guaranteed outcomes",
        "Handling difficult questions and pushback",
        "Creating alignment in the room",
        "Key takeaway: Meetings are won before they start."
      ]
    },
    {
      number: 10,
      title: "The Path to C-Suite",
      duration: "14 min",
      lessons: 1,
      icon: Crown,
      topics: [
        "What it really takes to become a C-level executive",
        "The hidden criteria for executive promotions",
        "Building your executive sponsor network",
        "Accelerating your timeline to senior leadership",
        "Key takeaway: The C-suite isn't about working harder. It's about being seen differently."
      ]
    }
  ];
            ...
            <div className="bg-gradient-to-br from-slate-900 to-black border-2 border-emerald-500 rounded-2xl p-8 md:p-12 shadow-2xl">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-lg text-white">20+ video masterclasses (3+ hours)</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-emerald-400 mt-1 flex-shrink-0" />
