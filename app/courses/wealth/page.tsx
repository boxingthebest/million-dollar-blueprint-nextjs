      ...
      <section className="py-16 bg-slate-950">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-white text-lg max-w-4xl mx-auto">
            <span className="text-cyan-100 font-semibold">Ray Dalio (Bridgewater)</span> • 
            <span className="text-cyan-100 font-semibold"> Warren Buffett (Berkshire Hathaway)</span> • 
            <span className="text-cyan-100 font-semibold"> Peter Thiel (Founders Fund)</span> • 
            <span className="text-cyan-100 font-semibold"> Vanguard advisors</span> • 
            <span className="text-cyan-100 font-semibold"> FIRE movement leaders</span>
          </p>
        </div>
      </section>
