    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="py-20 px-4 bg-slate-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mt-8"><a href="https://buy.stripe.com/3cs8wO2GR5Ql0bO5l208g0t" className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105">Get Instant Access — $77<ArrowRight className="w-5 h-5" /></a></div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-emerald-900/30 to-teal-900/30">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8"><span className="text-slate-500 line-through text-2xl">$297</span><span className="text-5xl font-black text-white">$77</span><span className="text-emerald-400 font-bold">Save $220</span></div>
          <a href="https://buy.stripe.com/3cs8wO2GR5Ql0bO5l208g0t" className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-12 py-5 rounded-xl font-bold text-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-emerald-500/25">Get Instant Access Now<ArrowRight className="w-6 h-6" /></a>
        </div>
      </section>
        ...
        {showStickyBar && (
          <motion.div initial={{ y: 100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 100, opacity: 0 }} className="fixed bottom-0 left-0 right-0 bg-slate-900/95 backdrop-blur-sm border-t border-slate-700 py-4 px-4 z-40">
            <div className="max-w-6xl mx-auto flex items-center justify-between">
              <div className="hidden md:block"><div className="text-white font-bold">Wealth Building</div><div className="text-slate-400 text-sm"><span className="line-through">$297</span><span className="text-emerald-400 ml-2 font-bold">$77</span></div></div>
              <a href="https://buy.stripe.com/3cs8wO2GR5Ql0bO5l208g0t" className="w-full md:w-auto bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-8 py-3 rounded-xl font-bold text-center transition-all duration-300">Get Instant Access — $77</a>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
